...
let ProposalUI = class ProposalUI extends BaseComponent {
    render() {
        ...
        if (proposal == null) {
            return React.createElement("div", { style: css({ display: "flex", alignItems: "center", justifyContent: "center", flex: 1, ...mwhTo0, fontSize: "25px" }) }, "Loading proposal...");
        }
        //let firstPostWritten = posts.length > 1 || posts[0].text != firstPostPlaceholderText;
        return (React.createElement(Column, { className: key("ProposalUI"), style: css({
            ...
            React.createElement(ScrollView, { ref: "scrollView", scrollVBarStyle: { width: 10 }, style: css({ flex: 1, ...mwhTo0 } /*styles.fillParent_abs*/) },
                React.createElement(Column, { style: css({ width: 960, margin: "50px auto 20px auto", filter: "drop-shadow(rgb(0, 0, 0) 0px 0px 10px)" }) },
...
let ProposalUI_Inner = class ProposalUI_Inner extends BaseComponentPlus({}, { editing: false, dataError: null }) {
    ...
    render() {
        ...
        if (editing) {
            return (React.createElement(Column, { sel: true, style: css({ flexShrink: 0, background: "rgba(0,0,0,.7)", borderRadius: 10, padding: 10, alignItems: "flex-start", cursor: "auto" }) },
        ...
        return (React.createElement(Row, { sel: true, style: css({ flexShrink: 0, background: "rgba(0,0,0,.7)", borderRadius: 10, alignItems: "initial", cursor: "auto" }) },
            React.createElement(Column, { p: 10, style: css({ flex: 1, ...mwhTo0 }) },
                ...
                React.createElement(Row, { mt: 5 },
                    React.createElement(Text, { style: css({ color: "rgba(255,255,255,.5)" }) },
                    ...
                    proposal.editedAt && React.createElement(Span, { ml: "auto", style: css({ color: "rgba(255,255,255,.5)" }) },
