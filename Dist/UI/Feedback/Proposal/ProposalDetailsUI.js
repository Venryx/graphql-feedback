...
let reactVMarkdown_importCache;
export function GetReactVMarkdown_Safe() {
    ...
    return reactVMarkdown_importCache !== null && reactVMarkdown_importCache !== void 0 ? reactVMarkdown_importCache : {
        MarkdownToolbar: () => React.createElement("div", null),
        MarkdownEditor: () => React.createElement("div", null),
    };
}
        ...
        return (React.createElement(Column, { style: E({ width: "100%", style }) },
            ...
            React.createElement(Row, { mt: 5 },
                React.createElement(Column, { style: { width: "100%" } },
                    ...
                    React.createElement(MarkdownEditor, { ref: "editor", toolbar: false, value: newData.text || "", onChange: val => Change(newData.text = val), options: E({
